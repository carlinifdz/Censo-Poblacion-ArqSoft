...
from views.crud_domicilio_habitante_view import MainMenuCRUDHabitantes
from views.editar_habitante_view import MainMenuEditHabitante
from views.editar_domicilio_view import MainMenuEditDomicilio
from views.editar_colonia_view import MainMenuEditColonia
...
class MainMenu():
    def __init__(self, user):
        ...
        ctk.CTkLabel(frame, text=f"Menú Principal - Usuario: {self.user}", font=font_title, text_color=text_color).grid(row=0, column=0, pady=25, columnspan=2)
        ...
        ctk.CTkButton( frame,text="Consultas",width=width,font=font, corner_radius=corner_radius, fg_color=button_color, text_color=button_text_color, command=self.abrir_consultas ).grid(row=5, column=0, pady=pady, columnspan=2)
        ...
        ctk.CTkLabel(frame, text="", font=font, text_color=text_color).grid(row=7, column=0, pady=0)
