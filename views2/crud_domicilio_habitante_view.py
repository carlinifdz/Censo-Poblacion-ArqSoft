...
row = 10
ctk.CTkButton(frame, text="Registrar", width=width, font=font, corner_radius=corner_radius, fg_color=button_color, text_color=button_text_color).grid(row=row, column=0, padx = padx, pady=pady)
ctk.CTkButton(frame, text="Eliminar Habitante", width=width, font=font, corner_radius=corner_radius, fg_color=button_color, text_color=button_text_color).grid(row=row, column=1, padx = padx, pady=pady)
ctk.CTkButton(frame, text="Eliminar Domicilio", width=width, font=font, corner_radius=corner_radius, fg_color=button_color, text_color=button_text_color).grid(row=row, column=2, padx = padx, pady=pady)
